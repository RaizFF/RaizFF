...
API_ID = int(environ.get('API_ID', '24750984'))
API_HASH = environ.get('API_HASH', '5b1a2547f10935cf103466c19b616829')
BOT_TOKEN = environ.get('BOT_TOKEN', "7792047476:AAEgPhQDRCTB7QS0q093RCCT4fYVlB2Qmyc")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://i.ibb.co/r2b273n0/x.jpg')).split()
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002961721162'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002937164678').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002735230093 -1001774659762') # give your force subscribe channel id here else leave it blank
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002937164678')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "MongoDb url & Db name
mongodb+srv://rahulyoutubar_db:OuakuqUodiEW2mNA@cluster0.gyjekgr.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
